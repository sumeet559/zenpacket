import json
from zenpacket.tlayer import TLayer
from zenpacket.tfield import TField
...
class Template:
    ...
    def __init__(self, name=None, raw=None, from_path=None,
        ...
        self._conds_path = dirname(zenpacket.conditions.__file__)
