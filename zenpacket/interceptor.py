...
class Interceptor(object):
    ...
    def __init__(self, tcp_ingress_rules="iptables -A INPUT -p tcp -m multiport --dports 20,21,23,25,53,80,110,119,135,139,161,162,389,443,465 -m conntrack --ctstate NEW,ESTABLISHED -j NFQUEUE --queue-num 2",
        tcp_egress_rules="iptables -A OUTPUT -p tcp -m multiport --dports 20,21,23,25,53,80,110,119,135,139,161,162,389,443,465 -m conntrack --ctstate ESTABLISHED -j NFQUEUE --queue-num 2",
